...
#define BACNET_PHYSICAL_BINARY_INPUT_COUNT 3U
#define BACNET_BINARY_INPUT_COUNT \
    (BACNET_PHYSICAL_BINARY_INPUT_COUNT + BACNET_STATUS_BINARY_INPUT_COUNT)
#define BACNET_COMPAT_ANALOG_VALUE_COUNT 10U
#define BACNET_INPUT_DIAGNOSTIC_START 11U
#define BACNET_INPUT_DIAGNOSTICS_PER_INPUT 3U
#define BACNET_ANALOG_VALUE_COUNT \
    (BACNET_INPUT_DIAGNOSTIC_START + \
     BACNET_PHYSICAL_BINARY_INPUT_COUNT * BACNET_INPUT_DIAGNOSTICS_PER_INPUT)
